  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-semibold text-[#1a1a1a] mb-6">
        {t('editProperty.amenitiesStep.title')}
      </h2>
        ...
        {AMENITIES.map((amenity) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-sm font-medium">{t(`editProperty.amenitiesStep.items.${amenity.name}`, { defaultValue: amenity.name })}</p>
            </button>
          )
        })}
      </div>
      ...
      <div className="bg-white rounded-2xl p-6">
        <Label className="text-[#1a1a1a] mb-3 block">
          {t('editProperty.amenitiesStep.additionalAmenities')}
        </Label>
        <div className="space-y-3">
          {[
            ...
            <div key={amenity} className="flex items-center">
              ...
              >
                {t(`editProperty.amenitiesStep.items.${amenity}`)}
              </label>
            </div>
          ))}
        </div>
